...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(3, 12, 24, 16),
        ...
        if self.mode == "classifier":
            ...
            #self.features.add_module('conv1', nn.Conv3d(1024, 512, kernel_size=1, stride=1, bias=False))
            #self.features.add_module('pool1', nn.AvgPool3d(kernel_size=2, stride=2))
            #self.features.add_module('norm6', nn.BatchNorm3d(512))
            #self.features.add_module('relu1', nn.ReLU(inplace=True))
            #self.features.add_module('conv2', nn.Conv3d(512, 32, kernel_size=1, stride=1, bias=False))
            #self.features.add_module('norm7', nn.BatchNorm3d(32))
